...
class VCachingOC {
    ...
    public function init()
    {
		...
		if(strpos(get_locale(), 'en_') === 0){
			load_textdomain( $this->plugin, plugin_basename( dirname( __FILE__ ) ) . '/languages/vcaching-en_US.mo' );
		}
		else{
    ...
    public function purge_varnish_cache_all_adminbar($admin_bar)
    {
        $admin_bar->add_menu(array(
            ...
            'title' => '<span class="ab-icon dashicons dashicons-randomize"></span>' . __('Purge Performance Cache', $this->plugin),
