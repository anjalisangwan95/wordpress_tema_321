...
if( ! defined( 'ONECOM_WP_VERSION' ) ) {
	define( 'ONECOM_WP_VERSION', '0.4.3' );
}
...
function onecom_generic_plugin_row_meta( $links, $file ) {
	...
	$new_links = array(
		'oc-health' => sprintf('<a href="%s">%s</a>',$health_url, __('Health Monitor', 'onecom-wp')),
		'oc-staging' => sprintf('<a href="%s">%s</a>',$stg_url, __('Staging', 'onecom-wp')),
		'oc-themes' => sprintf('<a href="%s">%s</a>',$themes_url, __('Themes')),
		'oc-plugins' => sprintf('<a href="%s">%s</a>',$plugin_url, __('Plugins'))
	);
